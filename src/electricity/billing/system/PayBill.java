...
//        ImageIcon i1 = new ImageIcon(getClass().getClassLoader().getResource("icon/bill.png"));
...
//        add(image);
        ...
        setVisible(true);
        URL url = getClass().getClassLoader().getResource("icon/bill.png");
        if (url != null) {
            ...
            System.out.println("Resource not found: icon/bill.png");
        }
